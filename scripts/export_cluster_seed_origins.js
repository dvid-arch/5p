...
const truestdataMatch = dataContent.match(/export const truestdata = (\[[\s\S]*?\]);/);
const truestdata = truestdataMatch ? eval(truestdataMatch[1]) : [];

const trioData = JSON.parse(fs.readFileSync(path.join(__dirname, '../advanced_combination_analysis.json'), 'utf-8'));
