...
function runProfitThresholdSimulation(odds, threshold) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        // 3. New seeds (Pick Top 3 per week to simulate reasonable bankroll)
    ...
    return { totalInvestment, totalRevenue, netProfit, roi, wins, losses, resets, maxDrawdown };
}

console.log("EXTENDED RESEARCH: 27-Step Fibonacci Chase");
console.log("Odd: 5.7 | Sequence: 1, 2, 3, 5... up to Step 27");
console.log("Step 27 value: " + generateFibo(27)[26].toLocaleString());
