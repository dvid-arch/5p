...
function ItemPut() {
    ...
    function handleArrAdd() {
        console.log(document.querySelector('#arr'))
        const arr = document.querySelector('#arr').value.split(',').map(n => Number(n))
        setData(arr)
    }
    return (
        <div className=" h-screen bg-black">
            <div>
                <input type="text" className="inline-block p-2 bg-white" id="arr" />
                <button className="inline-block p-2 bg-white " onClick={handleArrAdd}>submit</button>
            </div>
            <div className="flex">
