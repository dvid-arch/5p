                            ...
                            {chasePairs.map((cp) => (
                                ...
                                >
                                    ...
                                    <div className="space-y-2">
                                        <div className="text-sm font-medium text-gray-500 italic">Chase Readiness: <span className="text-gray-900 font-bold">READY</span></div>
                                        <div className="w-full bg-gray-100 h-2 rounded-full overflow-hidden">
                                            <div
                                                className="bg-indigo-500 h-full rounded-full transition-all duration-1000"
                                                style={{ width: `${(cp.weeksSinceLast / 15) * 100}%` }}
                                            />
                                        </div>
                                    </div>
                                </button>
